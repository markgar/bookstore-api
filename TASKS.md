...
- [ ] 2. Remove any default scaffolding or template code from the solution file (the current `.sln` has no project references — it will be populated as projects are created in the next steps).
